...
# Parsing of MAG
MAG_parsing = True                          # Set to True for parsing of MAG dataset
...
generate_mag_hashtable = False               # Set to True for generation of hashtable for MAG dataset
...
print_distance = False                      # To print Lavenshtein distance between each pair of titles
calculate_levenshtein_distance = False       # Calculate Lavenshtein distance between two titles